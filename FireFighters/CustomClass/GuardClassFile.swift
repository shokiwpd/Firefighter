...
class GuardFunc {
    func Guard1(Guard: Int, userGuard: Int) -> String!{
        ...
        case userGuard + 1: GuardNum = TextLabel.SoonTwoDay.rawValue
        case userGuard + 2 : GuardNum = TextLabel.SoonThreeDay.rawValue
    ...
    func Guard4(Guard: Int, userGuard: Int) -> String!{
        ...
        switch Guard{
        case userGuard: GuardNum = TextLabel.Today.rawValue
        case userGuard - 3: GuardNum = TextLabel.SoonTwoDay.rawValue
        case userGuard - 2 : GuardNum = TextLabel.SoonThreeDay.rawValue
        case userGuard - 1: GuardNum = TextLabel.Tomorrow.rawValue
        default:
            print("error")
